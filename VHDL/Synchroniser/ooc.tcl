...
####################################################################################
#
# Out of Context constraints for 'bus_data_valid_synch'.
#
...
# Additional 0.026 ns to solve a hold time violation on the registers on src_clk
# XXX Need to understand why when hold time of 0.161 should be sufficient.
set ths [expr 0.161 + 0.026]
...
create_clock -period 5.000 -name clk_src  [get_ports clk_src]
create_clock -period 7.000 -name clk_dest [get_ports clk_dest]
