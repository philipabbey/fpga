...
vlib work
vcom -quiet -2008 %SRC%\dut_register.vhdl %SRC%\external_signals_pkg.vhdl %SRC%\test_external_signals_process.vhdl %SRC%\test_external_signals_procedure.vhdl %SRC%\util_commands_pkg.vhdl %SRC%\test_force.vhdl %SRC%\test_util_comands.vhdl %SRC%\signal_spies_pkg.vhdl %SRC%\test_signal_spies.vhdl
set ec=%ERRORLEVEL%
