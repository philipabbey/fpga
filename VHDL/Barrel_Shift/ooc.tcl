...
# Kintex-7 Parts: xc7k70tfbv676-1
...
# Ensure all exteral paths are excluded from timing analysis when getting clock speed measurements.
set_false_path -to [get_cells data_in_i_reg[*]]
set_false_path -to [get_cells shift_i_reg[*]]
set_false_path -from [get_cells data_out_reg[*]]
set_property srl_style register [get_cells -hier *]
