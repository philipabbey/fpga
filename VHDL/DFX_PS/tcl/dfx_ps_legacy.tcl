...
proc create_root_design { parentCell } {
  ...
  set clk_port [ create_bd_port -dir I clk_port ]
...
\
  ...
  if { [catch {set vhdl_conv_i [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.rm_num_g {0} $vhdl_conv_i
  ...
  connect_bd_net -net clk_port_1 [get_bd_ports clk_port] [get_bd_pins vhdl_conv_i/clk_port]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net vhdl2018_1993_conv_0_disp_sel [get_bd_pins vhdl_conv_i/disp_sel] [get_bd_ports disp_sel]
  connect_bd_net -net vhdl2018_1993_conv_0_led [get_bd_pins vhdl_conv_i/led] [get_bd_ports led]
  connect_bd_net -net vhdl2018_1993_conv_0_sevseg [get_bd_pins vhdl_conv_i/sevseg] [get_bd_ports sevseg]
