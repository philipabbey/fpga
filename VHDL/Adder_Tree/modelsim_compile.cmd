...
echo.
echo   cd {%DEST%}
echo   vsim work.test_adder_tree              -voptargs="+acc" -t ps
echo   vsim work.test_adder_tree_pipe         -voptargs="+acc" -t ps
echo   vsim work.test_fir_filter_const_coeffs -voptargs="+acc" -t ps
echo   vsim work.test_fir_filter_var_coeffs   -voptargs="+acc" -t ps
echo.
echo ========================================================
echo.
