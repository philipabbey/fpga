...
vlib work
vcom -2008 %SRC%\adder_tree_pkg.vhdl %SRC%\adder_tree.vhdl %SRC%\adder_tree_pipe.vhdl %SRC%\test_adder_tree.vhdl %SRC%\test_adder_tree_pipe.vhdl %SRC%\fir_filter_const_coeffs.vhdl %SRC%\fir_filter_var_coeffs.vhdl %SRC%\test_fir_filter_const_coeffs.vhdl %SRC%\test_fir_filter_var_coeffs.vhdl %SRC%\fir_filter_const_coeffs_io.vhdl %SRC%\fir_filter_var_coeffs_io.vhdl
