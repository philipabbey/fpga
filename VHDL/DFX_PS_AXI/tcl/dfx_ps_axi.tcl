...
####################################################################################
#
# Vivado project creation script for DFX_PS_AXI.
#
# P A Abbey, 5 May 2025
#
####################################################################################
...
proc create_root_design { parentCell } {
  ...
  set disp_sel [ create_bd_port -dir O disp_sel ]
  set sevseg [ create_bd_port -dir O -from 6 -to 0 sevseg ]
...
\
  ...
  # Create instance: vhdl_conv_i, and set properties
  set block_name vhdl2018_1993_conv
  set block_cell_name vhdl_conv_i
  if { [catch {set vhdl_conv_i [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $vhdl_conv_i eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.rm_num_g {4} $vhdl_conv_i


  # Create interface connections
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins vhdl_conv_i/S_AXI_REG] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_net -net btn_1 [get_bd_ports btn] [get_bd_pins vhdl_conv_i/btn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins vhdl_conv_i/resetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins vhdl_conv_i/clk]
  ...
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins vhdl_conv_i/sw]
  connect_bd_net -net vhdl_conv_i_disp_sel [get_bd_pins vhdl_conv_i/disp_sel] [get_bd_ports disp_sel]
  connect_bd_net -net vhdl_conv_i_led [get_bd_pins vhdl_conv_i/led] [get_bd_ports led]
  connect_bd_net -net vhdl_conv_i_sevseg [get_bd_pins vhdl_conv_i/sevseg] [get_bd_ports sevseg]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00000100 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs vhdl_conv_i/S_AXI_REG/reg0] -force
