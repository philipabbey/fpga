...
current_project {dfx_ps_axi}

set block_diag [get_files -filter {FILE_TYPE == "Block Designs"}]
set proj_dir [get_property DIRECTORY [get_projects dfx_ps_axi]]
set proj_stem ${proj_dir}/[lindex [file split [get_property DIRECTORY [get_projects dfx_ps_axi]]] end]
